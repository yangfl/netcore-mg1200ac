...
#else
//ROM CODE
#define DECOMP_ADDR 0x80000000
//#define LZMA_STATUS_ADDR 0xa0100000
#define LZMA_STATUS_ADDR 0x80080000
#endif
...
#else
#define le32_to_cpu(x) ((unsigned int)(x))	// for little endian
#endif
...
//8196D
...
#endif
	inbuf = (unsigned char *)(((unsigned int)__boot_start));
	...
	unsigned char *startBuf=(unsigned char *)((unsigned int)inbuf);//__vmlinux_start;
	unsigned char *outBuf =(unsigned char *) ((unsigned int )outbuf);//(unsigned char *)output_start;
								//_bootimg_end
